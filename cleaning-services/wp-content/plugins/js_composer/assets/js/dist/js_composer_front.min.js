(document.documentElement.className += " js_active "),
  ...
  (() => {
    for (
      var e = ["-webkit-", "-moz-", "-ms-", "-o-", ""], t = 0;
      t < e.length;
      t++
    )
      e[t] + "transform" in document.documentElement.style &&
    ...
    "function" != typeof window.vc_js &&
      ...
      "function" != typeof window.vc_plugin_flexslider &&
        (window.vc_plugin_flexslider = function (e) {
          (e ? e.find(".wpb_flexslider") : jQuery(".wpb_flexslider")).each(
            function () {
              var e = jQuery(this),
      ...
      "function" != typeof window.vc_toggleBehaviour &&
        (window.vc_toggleBehaviour = function (e) {
          ...
          (e
            ? e.hasClass("vc_toggle_title")
              ? e.unbind("click")
              : e.find(".vc_toggle_title").off("click")
          ...
          function t() {
            ...
            e.toggleClass("wpb-tta-toggle-active"),
              e
                ...
                .each(function () {
                  if (!c(this).hasClass("vc_active"))
                    return c(this).find("a").click(), !1;
                });
          }
          (e ? e.find(".wpb-tta-toggle") : jQuery(".wpb-tta-toggle"))
            .off("click")
            .on("click", t),
            setTimeout(function () {
              jQuery(".wpb-tta-toggle").each(function () {
                ...
                e
                  ...
                  .hasClass("vc_active") || e.addClass("wpb-tta-toggle-active");
              });
            }, 1e3);
        }),
            ...
            e.each(function (e) {
              ...
              if (t && 0 < t)
                try {
                  ...
                  window.console &&
                    window.console.warn &&
                    console.warn("tabs behaviours error", e);
                }
              jQuery(this)
                .find(".wpb_tab")
                .each(function () {
                ...
                jQuery(this)
                  ...
                  .on("click", function (e) {
                    return (
                      e && e.preventDefault && e.preventDefault(),
                      n
                        ? i.tabs("select", jQuery("a", this).attr("href"))
                        : i.tabs("option", "active", jQuery(this).index()),
                      !1
                    );
                  }),
                jQuery(this)
                    ...
                    e && e.preventDefault && e.preventDefault(),
                      n
                        ...
                        : ((t = i.tabs("option", "active")),
                          ...
                          (t = jQuery(this).parent().hasClass("wpb_next_slide")
                            ? e <= t + 1
                              ? 0
                              : t + 1
                            : t - 1 < 0
            ...
            var t = jQuery(this),
              o =
                ...
                !isNaN(jQuery(this).data("active-tab")) &&
                  0 < parseInt(t.data("active-tab"), 10) &&
                  parseInt(t.data("active-tab"), 10) - 1),
              ...
              o = t.find(".wpb_accordion_wrapper").accordion({
                ...
                change: function (e, t) {
                  void 0 !== jQuery.fn.isotope &&
                    t.newContent.find(".isotope").isotope("layout"),
                    vc_carouselBehaviour(t.newPanel);
                },
              });
            !0 === t.data("vcDisableKeydown") &&
              (o.data("uiAccordion")._keydown = function () {});
          });
        }),
      ...
      "function" != typeof window.vc_carouselBehaviour &&
        (window.vc_carouselBehaviour = function (e) {
          (e ? e.find(".wpb_carousel") : jQuery(".wpb_carousel")).each(
            function () {
              var e = jQuery(this);
              !0 !== e.data("carousel_enabled") &&
                ...
                (e = jQuery(this).find(".wpb_thumbnails-fluid li")).css({
                  "margin-right": e.css("margin-left"),
                  "margin-left": 0,
                }),
                (e = jQuery(this).find("ul.wpb_thumbnails-fluid")).width(
                  e.width() + 300
                ));
            }
          );
      ...
      "function" != typeof window.vc_prettyPhoto &&
        (window.vc_prettyPhoto = function () {
          try {
            ...
            window.console &&
              window.console.warn &&
              window.console.warn("vc_prettyPhoto initialize error", e);
          }
        }),
      ...
      "function" != typeof window.vc_rowBehaviour &&
        (window.vc_rowBehaviour = function () {
          ...
          function e() {
            ...
            (void 0 !== window.wpb_disable_full_width_row_js &&
              ...
              l.each(e, function (e, t) {
                ...
                (u = u.length ? u : s.parent().next(".vc_row-full-width"))
                  .length &&
                  ...
                  s.attr("data-vc-full-width-init", "true"),
                  s.removeClass("vc_hidden"),
                  l(document).trigger("vc-full-width-row-single", {
                    el: s,
                    offset: n,
                    marginLeft: o,
                    marginRight: i,
          ...
          function t() {
            ...
            o.length &&
              ((e = l(window).height()), (t = o.offset().top) < e) &&
              o.css("min-height", 100 - t / (e / 100) + "vh"),
              l(document).trigger("vc-full-height-row", o);
          }
          l(window)
            ...
            (0 < window.navigator.userAgent.indexOf("MSIE ") ||
              ...
              l(".vc_row-o-full-height").each(function () {
                "flex" === l(this).css("display") &&
                  l(this).wrap('<div class="vc_ie-flexbox-fixer"></div>');
              }),
            ...
            l("[data-vc-parallax]").each(function () {
              ...
              (n = !0),
                ...
                (t = l("<div />")
                  ...
                  .appendTo(l(this))).height(e + "%"),
                (o = l(this).data("vcParallaxImage")),
                (i = vcExtractYoutubeId(o))
                  ? insertYoutubeVideoAsBackground(t, i)
                  : void 0 !== o && t.css("background-image", "url(" + o + ")"),
                t
      ...
      "function" != typeof window.wpb_prepare_tab_content &&
        (window.wpb_prepare_tab_content = function (e, t) {
          ...
          vc_carouselBehaviour(),
            ...
            t.newPanel.find(".vc_masonry_media_grid, .vc_masonry_grid")
              .length &&
              t.newPanel
            ...
            i.length &&
              !i.is(".map_ready") &&
              ((n = i.find("iframe")).attr("src", n.attr("src")),
              i.addClass("map_ready")),
      ...
      "function" != typeof window.vc_ttaActivation &&
        (window.vc_ttaActivation = function () {
          jQuery("[data-vc-accordion]").on("show.vc.accordion", function (e) {
            var t = window.jQuery,
              o = {};
            (o.newPanel = t(this).data("vc.accordion").getTarget()),
              window.wpb_prepare_tab_content(e, o);
          });
        }),
      "function" != typeof window.vc_accordionActivate &&
        (window.vc_accordionActivate = function (e, t) {
          ...
          t.newPanel.length &&
            ...
            void 0 !== jQuery.fn.isotope &&
              t.newPanel.find(".isotope, .wpb_image_grid_ul").isotope("layout"),
            t.newPanel.find(".vc_masonry_media_grid, .vc_masonry_grid")
              .length &&
              t.newPanel
                .find(".vc_masonry_media_grid, .vc_masonry_grid")
        ...
        (window.vc_initVideoBackgrounds = function () {
          c(".vc_video-bg").remove(),
            c("[data-vc-video-bg]").each(function () {
              ...
              o.data("vcVideoBg")
                ? ((e = o.data("vcVideoBg")),
                  (e = vcExtractYoutubeId(e)) &&
                    (o.find(".vc_video-bg").remove(),
                    insertYoutubeVideoAsBackground(o, e)),
      ...
      "function" != typeof window.vcResizeVideoBackground &&
        (window.vcResizeVideoBackground = function (e) {
          ...
          a / r < 16 / 9
            ? ((t = r * (16 / 9)),
              (o = r),
              (i = -Math.round((t - a) / 2) + "px"),
              (n = -Math.round((o - r) / 2) + "px"))
            : ((o = (t = a) * (9 / 16)),
              (n = -Math.round((o - r) / 2) + "px"),
              (i = -Math.round((t - a) / 2) + "px")),
            (t += "px"),
        ...
        (window.vc_setHoverBoxHeight = function (e) {
          e.each(function () {
            var e = jQuery(this),
              ...
              o =
                (t.css("min-height", 0),
                e.find(".vc-hoverbox-front-inner").outerHeight()),
